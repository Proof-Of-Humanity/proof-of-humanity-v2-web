...
const integrations: Record<string, Integration> = {
    ...
    firstInfoSlide: [
      {
        ...
        title: "Start",
        description:
          "Sign up for the [Gnosis App](https://app.gnosis.io/) on your desktop, or preferably your mobile browser.",
      ...
      },
      {
        ...
        description:
          "Log in and create a profile. Follow the simple steps within the Gnosis App to create your wallet and secure it with a passkey stored in your device's password manager.",
      ...
      },
      {
        ...
        description:
          "Once invited to Circles, copy your wallet address by clicking on the icon on the left of your profile picture.",
      ...
      },
      {
        ...
        description:
          "Click on the 'copy' icon to copy your wallet address. Now go back to the Proof Of Humanity page to paste your address and finish your Circles connection (Step 2 below).",
    ...
    firstInfoSlide: [
      {
        ...
        description:
          "Kleros is a decentralized dispute resolution protocol. Think of it as the “People’s Court” powered by Ethereum smart contracts and crowdsourced jurors. It’s used to settle disagreements where trust is hard like freelancing, DeFi, content moderation, identity, crypto token listings, and more.",
  ...
  "seer-credits": {
    ...
    description:
      "Claim your credits every month, and place your predictions on Seer.",
