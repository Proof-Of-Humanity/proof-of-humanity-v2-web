...
const Footer: React.FC = () => (
  <div className="header-background bottom-0 flex w-full flex-wrap items-center justify-center gap-x-4 gap-y-[20px] border-t border-white/[0.08] px-8 py-4 text-lg text-white sm:justify-between sm:gap-x-[240px]">
    <ExternalLink
