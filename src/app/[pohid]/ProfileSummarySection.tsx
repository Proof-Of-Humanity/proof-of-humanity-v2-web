  ...
  try {
    ...
    return (
      <>
        {claimedRegistration && homeChain ? (
          <div className="mb-3 flex flex-col items-center text-center">
            <div className="text-secondaryText flex text-sm">
              ...
              <ExternalLink
                className="ml-2 font-semibold text-peach underline underline-offset-2"
        ...
        {pageState === "TRANSFER_PENDING" ? (
          <span className="status-pill status-pill-warning mb-2">
            Transfer pending
          </span>
        ) : null}
        ...
        {showsWinningRequestCard && latestWinningRequest ? (
          ...
          <>
            {punishedVouchSourceHref ? (
              <div className="mb-6 flex max-w-xl flex-col items-center gap-3 px-6 text-center">
