            ...
            <div className="p-4 md:p-6 flex flex-col w-full ">
              ...
              <div className="flex items-start text-sm mt-2">
                ...
                <span className="text-secondaryText">
                  Make sure this is your correct Circles address. You need to be invited into Circles to be able to join the POH-circles group. Make sure you were invited before proceeding. Please, double check it before linking the accounts as its a <span className="text-[#EF4444] font-semibold">permanent action</span>.
                </span>
              </div>
              {(() => {
